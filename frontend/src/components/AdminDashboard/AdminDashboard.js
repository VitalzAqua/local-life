            ...
            <div className={styles.adminItemDetails}>
              ...
              {order.store_address && (
                <div className={styles.detailItem}>
                  ...
                  <span className={styles.detailValue}>
                    {typeof order.store_address === 'object' 
                      ? order.store_address.address || JSON.stringify(order.store_address)
                      : order.store_address}
                  </span>
                </div>
              )}
              {order.order_type === 'delivery' && order.customer_location && (
                <div className={styles.detailItem}>
                  ...
                  <span className={styles.detailValue}>
                    {typeof order.customer_location === 'object' 
                      ? order.customer_location.address || `${order.customer_location.lat}, ${order.customer_location.lng}`
            ...
            <div className={styles.adminItemDetails}>
              ...
              {reservation.store_address && (
                <div className={styles.detailItem}>
                  <span className={styles.detailLabel}>Address:</span>
                  <span className={styles.detailValue}>
                    {typeof reservation.store_address === 'object' 
                      ? reservation.store_address.address || JSON.stringify(reservation.store_address)
                      : reservation.store_address}
                  </span>
                </div>
              )}
