...
const config = {
  ...
  database: {
    connectionString: process.env.DATABASE_URL || 'postgresql://neondb_owner:npg_JcXhu4D5BpzS@ep-ancient-bird-a59vx2lc-pooler.us-east-2.aws.neon.tech/neondb?sslmode=require',
    pool: {
